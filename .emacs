...
(custom-set-variables
 ...
 '(package-selected-packages
   '(haskell-mode kotlin-mode goto-last-change proof-general auctex pdf-tools markdown-mode helm fzf sml-mode rainbow-mode multiple-cursors company-coq pretty-symbols auto-complete flycheck boogie-friends))
